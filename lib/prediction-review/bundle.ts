...
export function buildPredictionReviewBundleFromVersion(args: {
  ...
  return {
    ...
    bttsYesProb: pickProbability(markets, "btts", "yes") ?? 0,
    bttsNoProb: pickProbability(markets, "btts", "no") ?? 0,
    over25Prob: pickProbability(markets, "over_2_5", "over") ?? 0,
    under25Prob: pickProbability(markets, "over_2_5", "under") ?? 0,
