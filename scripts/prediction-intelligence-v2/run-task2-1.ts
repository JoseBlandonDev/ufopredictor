...
import { runTask2_1, type Task2Paths } from "../../lib/prediction-intelligence-v2/task2";
...
async function main() {
  ...
  const artifactsDir =
    ...
    path.join(repoRoot, "artifacts", "prediction-intelligence-v2", "task2-1", "local-run", new Date().toISOString().slice(0, 10));
