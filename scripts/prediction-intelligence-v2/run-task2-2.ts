...
import { runTask2_2 } from "../../lib/prediction-intelligence-v2/task2.ts";
...
async function main() {
  ...
  const artifactsDir = path.join(repoRoot, "artifacts", "prediction-intelligence-v2", "task2-2", artifactDate);
