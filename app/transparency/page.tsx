    ...
    <div className="space-y-8">
      <section className="ufo-card rounded-lg p-6 sm:p-7">
        ...
        <p className="mt-3 max-w-3xl text-[var(--muted)]">
          UFO Predictor es un producto de análisis probabilístico de fútbol. La versión pública
          actual muestra probabilidades, escenarios representativos y señales de contexto para
          ayudarte a interpretar cada partido sin presentar certezas.
        </p>
      </section>
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <section className="ufo-card rounded-lg p-6">
          ...
          <h2 className="mt-2 text-2xl font-semibold">Probabilidades, no certezas</h2>
        ...
        <section className="ufo-card rounded-lg p-6">
          ...
          <h2 className="mt-2 text-2xl font-semibold">Qué significan las señales</h2>
          <ul className="mt-4 space-y-2 text-sm text-[var(--muted)]">
            <li>1X2 te dice hacia dónde se inclina el modelo, no el resultado que debe ocurrir.</li>
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <section className="ufo-card rounded-lg p-6">
          <p className="font-mono text-xs uppercase tracking-[0.2em] text-[var(--accent)]">Datos de la versión actual</p>
          <h2 className="mt-2 text-2xl font-semibold">Qué usa hoy el producto</h2>
          <ul className="mt-4 space-y-2 text-sm text-[var(--muted)]">
